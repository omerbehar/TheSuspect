...
namespace Screens
{
    public class Screen7 : ScreenBaseWithTimer, ISingleAnswer, ILoadData, ISaveData, IHint
    {
        ...
        public void OnSelect(GameObject selectedGameObject)
        {
            ...
            PotentialScore = selectedGameObject == CorrectAnswer ? CorrectAnswerScore : 0;
        }
