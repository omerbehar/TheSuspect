...
public class ScreenManager : MonoBehaviour
{
    ...
    public void CheckAnswer()
    {
        ...
        switch (currentQuestion.Type)
        {
            ...
            // ... similar handling for other question types ...
    ...
    private int GetSelectedAnswerIndex()
    {
        switch (questions[currentQuestionIndex].type)
        {
            case QuestionType.MultipleChoice:
                ...
                return Array.FindIndex<>(toggles, toggle => toggle.value);

            case QuestionType.SingleChoice:
                var radioButtons = answersContainer.Children().OfType<RadioButton>();
                return Array.FindIndex<>(radioButtons, radioButton => radioButton.value);
